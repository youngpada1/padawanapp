...
# Set layout page to wide
        ...
        # Download resume
        with col2:
            resume = Path(__file__).parent / Path('images/Menu/FlaviaFerreira.pdf') #Resume
